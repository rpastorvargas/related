...
set modules_views_path1=../examples/practicas_sd/code/SimpleGeneratorModule.jar
set modules_views_path2=../examples/practicas_sd/code/CameraViewer.jar
set modules_views_path3=../examples/practicas_sd/code/ejs_levitador.jar
set modules_views_path4=../examples/practicas_sd/code/GlgCE.jar
set modules_views_path5=../examples/practicas_sd/code/GlgGraphLayout.jar
set modules_views_path6=../examples/practicas_sd/code/ImageViewerAxis.jar
set modules_views_path7=../examples/practicas_sd/code/MAGLEV_EJSView.jar
set modules_views_path8=../examples/practicas_sd/code/SignalGeneratorGLGView.jar
set modules_views_path9=../examples/practicas_sd/code/VideoServerRLABModule.jar

:: Conf file
set configFile=./conf/rlab_practicas_sd.properties

:: Conf file for Wrapper
set configWrapperFile=./conf/wrapper_win_practicas_sd.conf
