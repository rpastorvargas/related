...
modules_views_path3=../examples/tank_model/code/TankView.jar
modules_views_path4=../examples/tank_model/code/ejs_tank_view2.jar



# Conf file
configFile=./conf/tank_model/rlab_tank.properties

#  Conf file for Wrapper
configWrapperFile=./conf/tank_model/wrapper_tank.conf
