...
set modules_views_path1=../examples/motorQET/code/MAGLEVClientJavaApplication.jar
...
set modules_views_path7=../examples/motorQET/code/SimpleGeneratorModule.jar


:: Conf file
set configFile=./conf/rlab_MAGLEV.properties
